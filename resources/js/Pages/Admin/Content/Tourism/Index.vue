...
function applyFilters() {
    router.get(route('admin.tourism-destinations.index'), {
        search: search.value,
...
function confirmDelete() {
    ...
    router.delete(route('admin.tourism-destinations.destroy', itemToDelete.value.id), {
        onSuccess: () => {
...
<template>
    <Head title="Manajemen Destinasi Wisata - Admin Disparbud" />
        ...
        <div class="py-8 bg-slate-50 min-h-[calc(100vh-8rem)] dark:bg-slate-950 font-sans">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm overflow-hidden">
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-xs">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                <tr v-for="item in destinations.data" :key="item.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right space-x-2">
                                        <Link
                                            :href="route('admin.tourism-destinations.edit', item.id)"
                    ...
                    <!-- Pagination -->
                    <div v-if="destinations.links && destinations.links.length > 3" class="p-4 border-t border-slate-100 dark:border-slate-800 flex justify-center gap-1">
                        <Component
