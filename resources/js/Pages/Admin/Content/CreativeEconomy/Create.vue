...
const submit = () => {
  form.post(route('admin.creative-economies.store'), {
    forceFormData: true
  })
}
...
<template>
  <AuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-slate-800 leading-tight">Tambah Pelaku Ekraf Baru</h2>
    </template>
          ...
          <div class="p-6 text-slate-900">
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                >
                  {{ form.processing ? 'Menyimpan...' : 'Simpan Pelaku Ekraf' }}
                </button>
              </div>
            </form>
          </div>
