...
function applyFilters() {
    router.get(route('admin.culinary-places.index'), {
        search: search.value,
...
function confirmDelete() {
    ...
    router.delete(route('admin.culinary-places.destroy', itemToDelete.value.id), {
        onSuccess: () => {
                        ...
                        <table class="w-full text-left text-xs">
                            <thead class="bg-slate-50 dark:bg-slate-950 text-slate-400 font-bold uppercase border-b border-slate-200/80 dark:border-slate-800">
                                <tr>
                                    ...
                                    <th class="px-6 py-4">Nama Tempat Kuliner</th>
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                <tr v-for="item in items.data" :key="item.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right space-x-2">
                                        <Link
                                            :href="route('admin.culinary-places.edit', item.id)"
                                ...
                                <tr v-if="items.data.length === 0">
                                    <td colspan="6" class="px-6 py-12 text-center text-slate-400">
                                        Belum ada data destinasi kuliner.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
