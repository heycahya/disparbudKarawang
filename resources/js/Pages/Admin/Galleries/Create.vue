            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">File Media (Gambar/Foto)</label>
                            <input type="file" @input="form.media = $event.target.files[0]" class="mt-1 block w-full" accept="image/*" required />
