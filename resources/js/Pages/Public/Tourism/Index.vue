...
<template>
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 class="text-3xl font-bold mb-8 text-gray-800 dark:text-gray-200">Katalog Destinasi Wisata</h1>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div v-for="item in destinations.data" :key="item.id" class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden hover:shadow-lg transition">
            ...
            <div class="flex justify-center space-x-2 mt-8">
                <div v-for="link in destinations.links" :key="link.label">
                    <Link 
                        v-if="link.url" 
                        :href="link.url" 
